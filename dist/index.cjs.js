...
var Icon$q = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 32 32" }, props),
        React__default['default'].createElement("image", { width: "32", height: "32", href: "/images/carrot/logo.png" })));
};
...
var Icon$v = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 90 90" }, props),
        React__default['default'].createElement("image", { width: 90, height: 90, href: "/images/carrot/9.png" })));
};
...
var SpinnerIcon = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 96 96" }, props),
        React__default['default'].createElement("image", { width: "96", height: "96", href: "/images/carrot/9.png" })));
};
...
var Logo = function (_a) {
    ...
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 205 26" }, props),
        React__default['default'].createElement("image", { width: "205", height: "26", href: isDark ? '/images/carrot/LogoTextNewDark.png' : '/images/carrot/LogoTextNewWhite.png' })));
};
...
var Logo$1 = function (_a) {
    ...
    return (React__default['default'].createElement(Flex, null,
        ...
        isAbsoluteUrl ? (React__default['default'].createElement(StyledLink$1, { as: "a", href: href, "aria-label": "BunnySwap home page" }, innerLogo)) : (React__default['default'].createElement(StyledLink$1, { to: href, "aria-label": "BunnySwap home page" }, innerLogo))));
};
...
var links = [
    ...
    //     {
    //       label: "Overview",
    //       href: "https://info.bunnyswap.xyz",
    //     },
    //     {
    //       label: "Tokens",
    //       href: "https://info.bunnyswap.xyz/tokens",
    //     },
    //     {
    //       label: "Pairs",
    //       href: "https://info.bunnyswap.xyz/pairs",
    //     },
    //     {
    //       label: "Accounts",
    //       href: "https://info.bunnyswap.xyz/accounts",
    //     },
    //   ],
    // },
    // {
    ...
    // },
    {
        ...
        items: [
            // {
            //   label: "Voting",
            //   href: "https://voting.bunnyswap.xyz",
            // },
            {
                label: "Github",
...
var PanelFooter = function (_a) {
    var isPushed = _a.isPushed, pushNav = _a.pushNav, toggleTheme = _a.toggleTheme, isDark = _a.isDark, carrotPriceUsd = _a.carrotPriceUsd, currentLang = _a.currentLang, langs = _a.langs, setLang = _a.setLang, priceLink = _a.priceLink;
    if (!isPushed) {
    ...
    return (React__default['default'].createElement(Container$4, null,
        React__default['default'].createElement(SocialEntry, null,
            carrotPriceUsd ? (React__default['default'].createElement(PriceLink, { href: priceLink, target: "_blank" },
                React__default['default'].createElement(Icon$v, { width: "24px", mr: "8px" }),
                React__default['default'].createElement(Text, { color: "textSubtle", bold: true }, "$" + carrotPriceUsd.toFixed(3)))) : (React__default['default'].createElement(Skeleton, { width: 80, height: 24 })),
...
var AccountModal = function (_a) {
    ...
    return (React__default['default'].createElement(Modal, { title: "Your wallet", onDismiss: onDismiss },
        ...
        React__default['default'].createElement(Flex, { mb: "32px" },
            React__default['default'].createElement(LinkExternal, { small: true, href: "https://scan.pulsechain.com/address/" + account, mr: "16px" }, "View on BscScan"),
...
var Menu = function (_a) {
    var _b;
    var account = _a.account, login = _a.login, logout = _a.logout, isDark = _a.isDark, toggleTheme = _a.toggleTheme, langs = _a.langs, setLang = _a.setLang, currentLang = _a.currentLang, carrotPriceUsd = _a.carrotPriceUsd, links = _a.links, priceLink = _a.priceLink, profile = _a.profile, children = _a.children;
    ...
    return (React__default['default'].createElement(Wrapper$1, null,
        ...
        React__default['default'].createElement(BodyWrapper, null,
            React__default['default'].createElement(Panel, { isPushed: isPushed, isMobile: isMobile, showMenu: showMenu, isDark: isDark, toggleTheme: toggleTheme, langs: langs, setLang: setLang, currentLang: currentLang, carrotPriceUsd: carrotPriceUsd, pushNav: setIsPushed, links: links, priceLink: priceLink }),
...
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { background: "#FAF9FA", backgroundDisabled: "#E9EAEB", contrast: "#261324", invertedContrast: "#FFFFFF", input: "#eeeaf4", tertiary: "#EFF4F5", text: "#EA95BF", textDisabled: "#BDC2C4", textSubtle: "#ea95bf", borderColor: "#E9EAEB", card: "#ffffff", gradients: {
        bubblegum: "linear-gradient(139.73deg, #E6FDFF 0%, #F3EFFF 100%)",
    } });
var darkColors = __assign(__assign(__assign({}, baseColors), brandColors), { secondary: "#EA95BF", background: "#6d3568", backgroundDisabled: "#220522", contrast: "#ffffff", invertedContrast: "#0a0e17", input: "#2c222b", primaryDark: "#d95b00", tertiary: "#2c222b", text: "#FFFFFF", textDisabled: "#8b627f", textSubtle: "#ea95bf", borderColor: "#524B63", card: "#54194f", gradients: {
