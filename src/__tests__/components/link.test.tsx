...
it("renders link correctly", () => {
  const { asFragment } = renderWithTheme(<Link href="https://bunnyswap.xyz">Link</Link>);
  expect(asFragment()).toMatchInlineSnapshot(`
    <DocumentFragment>
      <a
        class="sc-bdfBwQ sc-gsTCUz cxXgLd djpNeP"
        color="primary"
        href="https://bunnyswap.xyz"
      >
        Link
      </a>
    </DocumentFragment>
...
it("renders link external link correctly", () => {
  const { asFragment } = renderWithTheme(<LinkExternal href="https://bunnyswap.xyz">Link</LinkExternal>);
  expect(asFragment()).toMatchInlineSnapshot(`
    <DocumentFragment>
      <a
        class="sc-bdfBwQ sc-gsTCUz cxXgLd djpNeP"
